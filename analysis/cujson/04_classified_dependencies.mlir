...
module {
  ...
  bitstream.analysis @cujson_tokenizer_polygeist_raised_analysis for @cujson_tokenizer_polygeist_raised {
    ...
    bitstream.dependency_group kind = "unbounded" {
      bitstream.dependency memory = raw producer_access = "a7" consumer_access = "a11" finite_state = none {buffer = @cujson_tokenizer_polygeist_raised::@arg3, consumer = @cujson_tokenizer_polygeist_raised::@_Z25findEscapedQuoteMerge_NEWPjS_S_iii, producer = @cujson_tokenizer_polygeist_raised::@_Z17bitMapCreatorSimdPjPhS0_S0_S0_yi}
      bitstream.dependency memory = raw producer_access = "a17" consumer_access = "a18" finite_state = none {buffer = @cujson_tokenizer_polygeist_raised::@arg4, consumer = @cujson_tokenizer_polygeist_raised::@_Z22inStringFinderBaselinePjS_S_i, producer = @cujson_tokenizer_polygeist_raised::@_Z33thrust_exclusive_scan_quote_countPjS_i}
    }
  }
}
