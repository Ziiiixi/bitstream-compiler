...
module {
  bitstream.pipeline @regex_0_polygeist_raised {
    ...
    bitstream.kernel @polygeist_stage0 {
      bitstream.state @state0 transition = regex_advance {advance_count = 92 : i64, advance_direction = "right", bits = 3 : i64, derived_from = "max bitstream.advance distance + 1", distance = 4 : i64, domain = 5 : i64, finite_state_source = "bitstream.advance", inferred, max_advance_distance = 4 : i64}
    ...
    bitstream.kernel @polygeist_stage1 {
      bitstream.state @state1 transition = regex_advance {advance_count = 1 : i64, advance_direction = "right", bits = 1 : i64, derived_from = "max bitstream.advance distance + 1", distance = 1 : i64, domain = 2 : i64, finite_state_source = "bitstream.advance", inferred, max_advance_distance = 1 : i64}
      %20 = bitstream.logical_index : index
      %21 = gpu.block_dim  x
    ...
    bitstream.kernel @polygeist_stage2 {
      bitstream.state @state2 transition = regex_advance {advance_count = 9 : i64, advance_direction = "right", bits = 2 : i64, derived_from = "max bitstream.advance distance + 1", distance = 2 : i64, domain = 3 : i64, finite_state_source = "bitstream.advance", inferred, max_advance_distance = 2 : i64}
      %20 = bitstream.logical_index : index
      %21 = gpu.block_dim  x
      %c-1 = arith.constant -1 : index
      %22 = arith.addi %21, %c-1 : index
  ...
  bitstream.analysis @regex_0_polygeist_raised_analysis for @regex_0_polygeist_raised {
    ...
    bitstream.fusion_candidate {legal = true, name = "regex_0_polygeist_raised_speculative_fusion", reason = "all producer dependencies have finite byte windows; regex advance has a finite-state proof", stages = [@regex_0_polygeist_raised::@polygeist_stage0, @regex_0_polygeist_raised::@polygeist_stage1, @regex_0_polygeist_raised::@polygeist_stage2], states = [@regex_0_polygeist_raised::@polygeist_stage0::@state0, @regex_0_polygeist_raised::@polygeist_stage2::@state2, @regex_0_polygeist_raised::@polygeist_stage1::@state1]}
    bitstream.fused_kernel @regex_0_polygeist_raised_speculative_fusion_kernel strategy = regex_advance_speculation {source_pipeline = @regex_0_polygeist_raised, stages = [@regex_0_polygeist_raised::@polygeist_stage0, @regex_0_polygeist_raised::@polygeist_stage1, @regex_0_polygeist_raised::@polygeist_stage2], states = [@regex_0_polygeist_raised::@polygeist_stage0::@state0, @regex_0_polygeist_raised::@polygeist_stage2::@state2, @regex_0_polygeist_raised::@polygeist_stage1::@state1]}
  }
}
