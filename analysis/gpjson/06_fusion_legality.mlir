...
module {
  ...
  bitstream.analysis @gpjson_driver_polygeist_raised_analysis for @gpjson_driver_polygeist_raised {
    ...
    bitstream.fusion_candidate {legal = true, name = "gpjson_driver_polygeist_raised_speculative_fusion", reason = "every dependency without a finite byte window has an exact finite-state proof; remaining dependencies have finite byte windows", stages = [@gpjson_driver_polygeist_raised::@_Z19gpjson_escape_carryPciS_, @gpjson_driver_polygeist_raised::@_Z19gpjson_escape_indexPclPbPl, @gpjson_driver_polygeist_raised::@_Z18gpjson_quote_indexPciPlS0_S_, @gpjson_driver_polygeist_raised::@_Z19gpjson_xor_pre_scanPci, @gpjson_driver_polygeist_raised::@_Z20gpjson_xor_post_scanPciiS_, @gpjson_driver_polygeist_raised::@_Z17gpjson_xor_rebasePciS_, @gpjson_driver_polygeist_raised::@_Z19gpjson_string_indexPliPc, @gpjson_driver_polygeist_raised::@_Z24gpjson_structural_bitmapPciPlS0_], states = [@gpjson_driver_polygeist_raised::@_Z17gpjson_xor_rebasePciS_::@state2, @gpjson_driver_polygeist_raised::@_Z19gpjson_string_indexPliPc::@state4, @gpjson_driver_polygeist_raised::@_Z19gpjson_xor_pre_scanPci::@state1, @gpjson_driver_polygeist_raised::@_Z20gpjson_xor_post_scanPciiS_::@state3]}
    bitstream.fused_kernel @gpjson_driver_polygeist_raised_speculative_fusion_kernel strategy = decoupled_lookback {source_pipeline = @gpjson_driver_polygeist_raised, stages = [@gpjson_driver_polygeist_raised::@_Z19gpjson_escape_carryPciS_, @gpjson_driver_polygeist_raised::@_Z19gpjson_escape_indexPclPbPl, @gpjson_driver_polygeist_raised::@_Z18gpjson_quote_indexPciPlS0_S_, @gpjson_driver_polygeist_raised::@_Z19gpjson_xor_pre_scanPci, @gpjson_driver_polygeist_raised::@_Z20gpjson_xor_post_scanPciiS_, @gpjson_driver_polygeist_raised::@_Z17gpjson_xor_rebasePciS_, @gpjson_driver_polygeist_raised::@_Z19gpjson_string_indexPliPc, @gpjson_driver_polygeist_raised::@_Z24gpjson_structural_bitmapPciPlS0_], states = [@gpjson_driver_polygeist_raised::@_Z17gpjson_xor_rebasePciS_::@state2, @gpjson_driver_polygeist_raised::@_Z19gpjson_string_indexPliPc::@state4, @gpjson_driver_polygeist_raised::@_Z19gpjson_xor_pre_scanPci::@state1, @gpjson_driver_polygeist_raised::@_Z20gpjson_xor_post_scanPciiS_::@state3]}
  }
}
